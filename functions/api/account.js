import { getAccessIdentityEmail, getActiveGrant, makeId, normalizeEmail, nowIso, privateErrorJson, privateJson, requireDb } from './_utils.js';
...
export const onRequestPost = async ({ request, env }) => {
  try {
    const identityEmail = await getAccessIdentityEmail(request, env);
